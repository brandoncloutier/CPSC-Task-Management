...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const EYE = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" ...></svg>';
    const EYEOFF = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" ...></svg>';
    ...
    signupForm.addEventListener("submit", async (event) => {
        ...
        try {
            const { data: { user }, error } = await supabase.auth.signUp({ email, password, options: { data: { first_name: firstName || null }}})
